// Neopixel
#define PIN D4          // PIN (5 / D1) where neopixel / WS2811 strip is attached
#define NUMLEDS 96      // Number of leds in the strip
//#define BUILTIN_LED 2   // ESP-12F has the built in LED on GPIO2, see https://github.com/esp8266/Arduino/issues/2192
#define BUTTON 5//4        // Input pin (4 / D2) for switching the LED strip on / off, connect this PIN to ground to trigger button.

const char HOSTNAME[] = "ESP32";   // Friedly hostname
